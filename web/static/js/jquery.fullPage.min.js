...
!function (e, n) {
    ...
    e.fn.fullpage = function (l) {
        ...
        function Z() {
            Kn.css({
                ...
                var t = e(this), o = t.find(D), i = o.length;
                re(t, n), ae(t, n), i > 0 ? $(t, o, i) : l.verticalCentered && cn(t)
            }), l.fixedElements && l.css3 && e(l.fixedElements).appendTo(Vn), fe(), ue(), l.scrollOverflow ? ("complete" === t.readyState && de(), ne.on("load", de)) : pe()
        }
        ...
        function ve() {
            ...
            if (!l.autoScrolling || l.scrollBar) {
                var o = ne.scrollTop(), i = ge(o), r = 0, a = o + ne.height() / 2, s = Vn.height() - ne.height() === o, c = t.querySelectorAll(y);
                if (s)r = c.length - 1; else for (var d = 0; d < c.length; ++d) {
                    var f = c[d];
                    f.offsetTop <= a && (r = d)
                }
                if (me(i) && (e(b).hasClass(m) || e(b).addClass(m).siblings().removeClass(m)), n = e(c).eq(r), !n.hasClass(p)) {
                    lt = !0;
                    var u = e(b), h = u.index(y) + 1, v = an(n), g = n.data("anchor"), S = n.index(y) + 1, w = n.find(z);
                    if (w.length)var C = w.data("anchor"), T = w.index();
                    Zn && (n.addClass(p).siblings().removeClass(p), e.isFunction(l.onLeave) && l.onLeave.call(u, h, S, v), e.isFunction(l.afterLoad) && l.afterLoad.call(n, g, S), ze(u), Re(n), De(n), rn(g, S - 1), l.anchors.length && (Wn = g, gn(T, C, g, S))), clearTimeout(ot), ot = setTimeout(function () {
                        lt = !1
                    }, 100)
                }
        ...
        function we(n) {
            ...
            if (!ye(n.target) && be(t)) {
                ...
                var i = e(b), r = l.scrollOverflowHandler.scrollable(i);
                if (Zn && !Xn) {
                    var a = En(t);
        ...
        function xe(t) {
            var i = (new Date).getTime(), r = e(g).hasClass(A);
            if (l.autoScrolling && !Yn && !r) {
                ...
                var f = e(b), u = l.scrollOverflowHandler.scrollable(f), h = i - ht;
                if (ht = i, h > 200 && ($n = []), Zn) {
                    var p = Te($n, 10), v = Te($n, 70), m = p >= v;
        ...
        function ke(n, t) {
            var o = "undefined" == typeof t ? e(b) : t, i = o.find(F), r = i.find(D).length;
            if (!(!i.length || Xn || 2 > r)) {
                var a = i.find(z), s = null;
        ...
        function Ae(e) {
            var n = e.position(), t = n.top, o = n.top > pt, i = t - Qn + e.outerHeight(), r = l.bigSectionsDestination;
            return e.outerHeight() > Qn ? (!o && !r || "bottom" === r) && (t = i) : (o || Gn && e.is(":last-child")) && (t = i), pt = t, t
        }
        ...
        function Me(n, t, o) {
            if ("undefined" != typeof n) {
                ...
                if (!(r.activeSection.is(n) && !Gn || l.scrollBar && ne.scrollTop() === r.dtop && !n.hasClass(L))) {
                    if (r.activeSlide.length)var a = r.activeSlide.data("anchor"), s = r.activeSlide.index();
        ...
        function He(n) {
            Be(n), e.isFunction(l.afterLoad) && !n.localIsResizing && l.afterLoad.call(n.element, n.anchorLink, n.sectionIndex + 1), l.scrollOverflowHandler.afterLoad(), De(n.element), n.element.addClass(m).siblings().removeClass(m), Zn = !0, e.isFunction(n.callback) && n.callback.call(this)
        }
        ...
        function Ve() {
            if (!lt && !l.lockAnchors) {
                var e = n.location.hash.replace("#", "").split("/"), t = decodeURIComponent(e[0]), o = decodeURIComponent(e[1]), i = "undefined" == typeof Wn, r = "undefined" == typeof Wn && "undefined" == typeof o && !Xn;
        ...
        function Qe(n) {
            n.preventDefault();
            var t = e(this).closest(y).find(F), o = t.find(D).eq(e(this).closest("li").index());
            Ze(t, o)
        }
        ...
        function Ze(n, t) {
            var i = t.position(), r = t.index(), a = n.closest(y), s = a.index(y), c = a.data("anchor"), d = a.find(Y), f = wn(t), u = a.find(z), h = Gn;
            if (l.onSlideLeave) {
                var m = u.index(), g = ln(m, r);
        ...
        function hn(e, n) {
            var t = n.find(F), o = t.find(D + '[data-anchor="' + e + '"]');
            return o.length || (o = t.find(D).eq(e)), o
        }

        function pn(e, n) {
            var t = un(e);
            "undefined" == typeof n && (n = 0), e === Wn || t.hasClass(p) ? vn(t, n) : Me(t, function () {
                vn(t, n)
            })
        }
        ...
        function Sn(e) {
            if (l.recordHistory)location.hash = e; else if (Nn || jn)n.history.replaceState(i, i, "#" + e); else {
        ...
        function yn() {
            var n = e(b), t = n.find(z), o = wn(n), i = wn(t), r = String(o);
        ...
        function On(e) {
            if (l.scrollBar)Kn.scrollTop(e); else if (l.css3) {
        ...
        function Rn() {
            On(0), Kn.find("img[data-src], source[data-src], audio[data-src], iframe[data-src]").each(function () {
                e(this).attr("src", e(this).data("src")), e(this).removeAttr("data-src")
            }), e(E + ", " + Y + ", " + j).remove(), e(y).css({
                height: "",
                "background-color": "",
                padding: ""
            }), e(D).css({width: ""}), Kn.css({
                height: "",
                position: "",
                "-ms-touch-action": "",
                "touch-action": ""
                ...
                overflow: "",
                height: ""
            }), e("html").removeClass(u), Vn.removeClass(c), e.each(Vn.get(0).className.split(/\s+/), function (e, n) {
        ...
        var Fn = e("html, body"), Vn = e("body"), Un = e.fn.fullpage;
        l = e.extend({
            menu: !1,
            anchors: [],
            lockAnchors: !1,
        ...
        var Wn, qn, Yn, Xn = !1, Nn = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), jn = "ontouchstart"in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Kn = e(this), Qn = ne.height(), Gn = !1, Jn = !0, Zn = !0, $n = [], _n = {};
        _n.m = {up: !0, down: !0, left: !0, right: !0}, _n.k = e.extend(!0, {}, _n.m);
        var et, nt, tt, ot, it, rt, at = e.extend(!0, {}, l);
        zn(), oe.click = jn, oe = e.extend(oe, l.scrollOverflowOptions), e.extend(e.easing, {
            ...
            var n = e(b).prev(y);
            n.length || !l.loopTop && !l.continuousVertical || (n = e(y).last()), n.length && Me(n, null, !0)
        }, Un.moveSectionDown = function () {
            var n = e(b).next(y);
            n.length || !l.loopBottom && !l.continuousVertical || (n = e(y).first()), n.length && Me(n, null, !1)
            ...
            if (!Kn.hasClass(f)) {
                Gn = !0, Qn = ne.height(), e(y).each(function () {
                    var n = e(this).find(F), t = e(this).find(D);
        ...
        var lt = !1, st = 0, ct = 0, dt = 0, ft = 0, ut = 0, ht = (new Date).getTime(), pt = 0, vt = 0, mt = Qn;
    ...
    var ie = {
        refreshId: null, iScrollInstances: [], onLeave: function () {
            ...
            o.height(t), o.each(function () {
                var n = jQuery(this), t = n.data("iscrollInstance");
